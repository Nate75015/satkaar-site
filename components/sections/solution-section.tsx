...
const phoneMockups = [phoneMockup1, phoneMockup2, phoneMockup3];
    ...
    <div className="flex items-center justify-center p-4">
      <div className="w-full max-w-6xl">
        ...
        <div className="relative">
          {/* Background shape */}
          <div className="absolute inset-0 bg-rose-900 rounded-oso-m shadow-2xl" 
               style={{ height: '780px', top: '50%', transform: 'translateY(-40%)', right: '0' }}>
          </div>
          ...
          <div className="overflow-visible py-16" ref={emblaRef}>
            <div className="flex gap-8 px-8">
              {slides.map((slide, index) => (
                <div
                  key={index}
                  className="flex-none w-full md:w-1/3 flex justify-center"
...
export function SolutionSection() {
  ...
  // Embla carousel with center mode effect
  const [emblaRef, emblaApi] = useEmblaCarousel({
    loop: true,
    align: "center",
    slidesToScroll: 1,
    ...
    <section className="py-16 lg:py-24 bg-white">
      <div className="container-oso">
        ...
        >
          {/* Title */}
          <motion.h2
            className="font-heading font-semibold text-[28px] md:text-[35px] lg:text-[39px] text-gris-70 text-center"
          ...
          <div className="w-full flex flex-col lg:flex-row items-start lg:items-center gap-8 lg:gap-12">
            ...
            <motion.div
              className="w-full lg:w-auto lg:shrink-0 lg:max-w-[335px] flex flex-col gap-6"
            ...
            >
              ...
              <div className="flex flex-col gap-4">
                <p className="font-heading text-[20px] md:text-[24px] text-gris-60 leading-normal">
                  <span className="font-normal">Tout est </span>
                  <span className="font-semibold text-[#d9325e]">clair</span>
                  <span className="font-normal">.</span>
                </p>
                <div className="font-body text-[14px] md:text-[16px] text-gris-60 leading-normal">
                  <p className="mb-2">
              ...
              {/* Divider */}
              <div className="w-[305px] max-w-full h-px bg-gris-40" />
              ...
              <div className="flex flex-col gap-4">
                <p className="font-heading text-[20px] md:text-[24px] text-gris-60 leading-normal">
                  ...
                  <span className="font-semibold text-rose-300">On S'en Occupe</span>
                  <span className="font-normal">.</span>
                </p>
                <div className="font-body text-[14px] md:text-[16px] text-gris-60 leading-normal">
                  <p className="mb-2">
